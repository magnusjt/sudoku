...
import { difficulties } from 'sudoku-core/lib/solve'
...
import { Board } from 'sudoku-core/lib/types'
...
const loadPuzzleData = async () => {
    globalPuzzleData = await fetch(process.env.PUBLIC_URL + '/boards/boardsV5.txt')
        .then(x => x.text())
        .then(x => x
            .split('\n')
